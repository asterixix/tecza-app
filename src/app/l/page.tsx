      ...
      <Card>
        <CardContent className="p-6">
          ...
          <p className="mt-1 text-muted-foreground">
            Wprowadź swój email i hasło, lub zaloguj się korzystając z konta Google lub Discorda.
          </p>
          ...
          <div className="mt-4 grid gap-3">
            ...
            >
              <svg aria-hidden width="16" height="16" viewBox="0 0 24 24" className="mr-2">
                <path
                  fill="currentColor"
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-3">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription id="otp-help">
                        Wprowadź 6‑cyfrowy kod z aplikacji uwierzytelniającej (TOTP).
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="mt-1 flex items-center justify-between">
                ...
                <Link className="text-sm text-muted-foreground hover:text-foreground" href="/r">
