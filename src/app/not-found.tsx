...
export default function NotFound() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 md:px-6 py-12 md:py-16">
      <div className="mb-4">
        <Badge variant="secondary" aria-label="Kod błędu">
          404 • Nie znaleziono
        </Badge>
      </div>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <Button asChild variant="secondary" aria-label="Zgłoś problem w GitHub">
          <a
            href="https://github.com/asterixix/tecza-app/issues/new"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <Card className="mt-8" aria-label="Szczegóły debugowania">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 text-sm font-medium">
            <Info className="size-4" /> Szczegóły debugowania
          </div>
          <pre className="mt-3 max-h-[320px] overflow-auto rounded-md bg-muted/60 p-3 text-xs leading-relaxed">
