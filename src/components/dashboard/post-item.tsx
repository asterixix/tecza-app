...
export function PostItem({
  ...
  post: PostRecord
  canManage?: boolean
  onChange?: (type: "updated" | "deleted", post: PostRecord) => void
}) {
        ...
        return (
          <HoverCard key={i}>
            <HoverCardTrigger asChild>
              <a href={`/u/${uname}`} className="text-primary hover:underline">
                {p}
              </a>
            </HoverCardTrigger>
            <HoverCardContent>
  ...
  function isTenorHost(raw: string) {
    try {
      ...
      // allow tenor.com and any subdomain like media.tenor.com
